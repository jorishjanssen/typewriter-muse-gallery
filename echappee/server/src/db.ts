...
CREATE TABLE IF NOT EXISTS clusters (
  ...
  brief TEXT,
  brief_at TEXT,
  brief_article_count INTEGER
);

ALTER TABLE clusters ADD COLUMN IF NOT EXISTS brief TEXT;
ALTER TABLE clusters ADD COLUMN IF NOT EXISTS brief_at TEXT;
ALTER TABLE clusters ADD COLUMN IF NOT EXISTS brief_article_count INTEGER;
ALTER TABLE clusters ADD COLUMN IF NOT EXISTS bookmarked_at TEXT;
